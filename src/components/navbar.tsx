  ...
  return (
    <div className='flex justify-evenly py-4 shadow bg-[#fff]'>
        <div className='flex gap-1 items-center mx-5 lg:mx-10'>
                <img className='h-[15px] lg:h-[25px]' src={logo} alt="logo" />
                <span className='font-avenir font-bold text-[#213F7D] text-lg lg:text-3xl'>lendsqr</span>
        </div>

        <form className='hidden lg:flex mx-10 border-[1px] pl-2 rounded-lg w-[25em]'>
        ...
        <div className='flex ml-auto px-5 lg:px-10 text-xs sm:text-base items-center gap-7 text-[#213f7d]'>
            <p className='underline underline-offset-2'>Docs</p>
            <button>
