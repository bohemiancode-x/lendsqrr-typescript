...
const navbar = () => {
  return (
    <div className='flex justify-evenly py-4 shadow bg-[#fff]'>
        ...
        <div className='flex ml-auto px-10 items-center gap-7 text-[#213f7d]'>
            <p className='underline underline-offset-1'>Docs</p>
            <button>
                <AiOutlineBell className='text-xl'/>
            </button>
            <div className="user flex gap-3 items-center">
                <img className='rounded-full' src={userimg} alt="userimage" />
                <p>Adedeji</p>
                <RiArrowDownSFill />
            </div>
        </div>
